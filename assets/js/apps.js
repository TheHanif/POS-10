$(document).ready(function(){
	...
	if ($('#datatable-example3').length > 0){
		$('#datatable-example3').dataTable();
	}
	if ($('#datatable-example4').length > 0){
		$('#datatable-example4').dataTable();
	}
	if ($('#datatable-example5').length > 0){
		$('#datatable-example5').dataTable();
	}
	...
	if ($('#morris-widget-10').length > 0){
	Morris.Line({
	  element: 'morris-widget-01',
	  data: [
		{ y: '2000', a: 34},
		{ y: '2001', a: 55},
		{ y: '2002', a: 60},
	...
	if ($('#morris-widget-20').length > 0){
	//MORRIS
	Morris.Bar({
	  element: 'morris-widget-20',
	  data: [
		{ y: 'Indonesia', a: 952},
		{ y: 'India', a: 985},
...
if ($('#realtime-chart-widget').length > 0){
	...
	$("#color-reset").click(function(){
		"use strict";
		$(".top-navbar").removeClass("white-color");
	...
	$("#change-color-light").click(function(){
		...
		$(".top-navbar").removeClass("danger-color");
		$(".top-navbar").removeClass("warning-color");
		$(".top-navbar").addClass("white-color");
