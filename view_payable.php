			...
			<div class="the-box">
				<div class="table-responsive">
					<?php
						...
						$results = $accounts->get_payable_receviable_report($account = NULL, $account_type = NULL, $to_date = NULL, $from_date = NULL, $type = 'payable', $status = 0);
						if ($results) {
						//	print_f($results);
						?>
						<table class="table table-striped table-hover" id="datatable-example">
							...
							<tbody>
								...
								<td><a href="#" class="btn btn-info active">Pay</a></td>
								</tr>
								<?php
								}
								?>
						...
						<?php
							...
							echo '<div class="alert alert-danger" role="alert"> No Account Payable Available. </div>';
						} 
						?>
